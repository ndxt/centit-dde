...
public class MDIbmDb2Database extends IbmDb2Database implements MDDatabase {
    private final static String sqlGETTABLES = " select NAME AS TABLE_NAME  from  sysibm.systables where  type ='T' and creator= ? ";
