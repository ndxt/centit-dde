...
public class MDMsSqlsvrDatabase extends MsSqlsvrDatabase implements MDDatabase {
    private final static String sqlGETTABLES = "select name AS TABLE_NAME from sysobjects where xtype='U'";
