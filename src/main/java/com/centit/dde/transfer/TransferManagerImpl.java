...
public class TransferManagerImpl implements TransferManager {
    ...
    private TransferResult runDataMap(ExchangeMapinfo exchangMapinfo, Long taskLogId) {
        ...
        // 准备环境
        DatabaseInfo sourceDatabaseInfo = databaseInfoDao.getObjectById(exchangMapinfo.getSourceDatabaseName());
        ...
        DatabaseInfo desDatabaseInfo = databaseInfoDao.getObjectById(exchangMapinfo.getDestDatabaseName());
