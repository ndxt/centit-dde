...
//   角色编辑控制器
    ...
    var ExchangeTask2Edit = require('./exchangeTask2.edit');
    var ExchangeTask2Remove = require('./exchangeTask2.remove');

    // 业务信息
    var ExchangeTask2 = Page.extend(function() {
    	
    	
//    	调用injecte方法注入该控制器的实例(角色编辑控制器)
    	this.injecte([
          new ExchangeTask2Add('exchangeTask2_add'),
          new ExchangeTask2Edit('exchangeTask2_edit'),
          new ExchangeTask2Remove('exchangeTask2_remove')
    	]);
