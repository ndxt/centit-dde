...
//   角色编辑控制器
    ...
    var ExchangeMapinfoNewEdit = require('./exchangeMapinfoNew.edit');
    var ExchangeMapinfoNewRemove = require('./exchangeMapinfoNew.remove');

    // 业务信息
    var ExchangeMapinfoNew = Page.extend(function() {
    	
    	
//    	调用injecte方法注入该控制器的实例(角色编辑控制器)
    	this.injecte([
          new ExchangeMapinfoNewAdd('exchangeMapinfoNew_add'),
          new ExchangeMapinfoNewEdit('exchangeMapinfoNew_edit'),
          new ExchangeMapinfoNewRemove('exchangeMapinfoNew_remove')
    	]);
