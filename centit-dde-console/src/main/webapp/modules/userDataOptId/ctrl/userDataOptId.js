...
//   角色编辑控制器
    var UserDataOptIdAdd = require('./userDataOptId.add');
    var UserDataOptIdEdit = require('./userDataOptId.edit');
    var UserDataOptIdRemove = require('./userDataOptId.remove');

    // 业务信息
    var UserDataOptId = Page.extend(function() {
    	
    	
//    	调用injecte方法注入该控制器的实例(角色编辑控制器)
    	this.injecte([
          new UserDataOptIdAdd('userDataOptId_add'),
          new UserDataOptIdEdit('userDataOptId_edit'),
          new UserDataOptIdRemove('userDataOptId_remove')
    	]);
