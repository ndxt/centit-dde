...
//   角色编辑控制器
    ...
    var importTaskEdit = require('./importTask.edit');
    var importTaskRemove = require('./importTask.remove');

    // 业务信息
    var importTask = Page.extend(function() {
    	
    	
//    	调用injecte方法注入该控制器的实例(角色编辑控制器)
    	this.injecte([
          new importTaskAdd('importTask_add'),
          new importTaskEdit('importTask_edit'),
          new importTaskRemove('importTask_remove')
    	]);
