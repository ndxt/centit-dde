...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li class="new">
				<a href="${pageContext.request.contextPath }/sys/deptManager!bulitUserRole.do?userrole.usercode=${usercode}&tabid=userDefView"
		...
		<tbody>
			<c:forEach items="${userroles}" var="role">
				<tr align="center">
					...
					<td align="center">
                        <c:if test="${not (fn:startsWith(role.rolecode, 'G-'))}">
                            <a href="${pageContext.request.contextPath }/sys/userDef!editUserRole.do?usercode=${role.usercode}&userrole.id.rolecode=${role.rolecode}&obtaindate=${role.obtaindate}&tabid=userDefView"
                               class="edit" target="dialog" title="编辑用户角色" rel="userDefView" width="510" height="360">
                                <span title="编辑用户角色" class="icon icon-edit"></span>
                            </a>
                            <a href="${pageContext.request.contextPath }/sys/userDef!deleteUserRole.do?userrole.id.usercode=${role.usercode}&userrole.id.rolecode=${role.rolecode}&obtaindate=${role.obtaindate}&tabid=userDefView"
