...
<div class="pageContent">
	<s:form action="/sys/addressBook!editAndSave.do" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);" id="addressBookFrom">
		...
		<div class="pageFormContent" layoutH="56">
			...
			<fieldset>
				...
				<dl>
					<dt>姓名：</dt>
					<dd>
						<input value="${bodyname}" name="bodyname" type="text" />
					</dd>
				</dl>
				<dl>
					<dt>用户代码：</dt>
					<dd>
						<input type="text" name="usercode" value="${usercode}" readonly="readonly" />
					</dd>
				</dl>
				<dl>
					<dt>通讯主体类别：</dt>
					...
					<dl>
						...
						<dd>
							<select size="50" name="unitcode" class="combox">
								...
								<option value="0" <c:if test="${object.unitcode eq 0}">selected = "selected"</c:if> >其他</option>
							</select>
						</dd>
					</dl>
				<dl>
