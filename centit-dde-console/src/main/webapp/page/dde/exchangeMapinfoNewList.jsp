...
<form id="pagerForm" method="post" action="${pageContext.request.contextPath }/dde/exchangeMapinfoNew!list.do">
...
<div class="pageHeader">
	<form id="pagerForm" onsubmit="return navTabSearch(this);" action="${pageContext.request.contextPath }/dde/exchangeMapinfoNew!list.do" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	...
	<c:set var="addmapinfo">
        <div class="panelBar">
            <ul class="toolBar">
                <li class="new">
                  <a class="add" href="${contextPath }/dde/exchangeMapinfoNew!showMapinfoDetail.do?1=1" warn="请选择一条记录" target='navTab' rel="exchangeMapinfoNewAdd"><span>添加</span></a>                   
                </li>
            </ul>
        </div>
    </c:set>
