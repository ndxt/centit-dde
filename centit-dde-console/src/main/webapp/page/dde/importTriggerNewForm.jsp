...
<div id="div_import_trigger_form" class="pageContent">
	<s:form action="#" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<input id="hid_import_trigger_form_triggerId" type="hidden" name="triggerId" value="${param.columnNo}"/>
			...
			<ul>
				<li><div class="buttonActive">
						<div class="buttonContent">
							<button id="btn_import_trigger" type="button">保存</button>
						</div>
					</div></li>
				<li>
					<div class="button">
