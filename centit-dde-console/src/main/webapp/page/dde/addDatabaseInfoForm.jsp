...
<div class="pageContent">
    <s:form action="/dde/databaseInfo!save.do" class="pageForm required-validate"
        ...
        <div class="pageFormContent" layoutH="58">
            ...
            <div class="unit">
                <label>密码：</label>
                <input name="password" type="password" size="40" value="${object.password }"/>
            </div>
            <div class="unit">
                ...
                <%-- <div class="unit">
                    <label>创建时间：</label>
                    <input type="text" name="createTime" class="date" value="${object.createTime }" format="yyyy-MM-dd HH:mm:ss"/>
