	...
	<dl class="nowrap">
		...
		<dd>
			<input name="sourceDatabaseName" type="text" size="30" class="sourceDatabaseName" value="${object.sourceDatabaseName}"/> <a
				...
				href="${pageContext.request.contextPath }/dde/databaseInfo!defSourceAndDestDatabase.do?s_type=source"
	...
	<dl class="nowrap">
		...
		<dd>
			<input name="goalDatabaseName" type="text" size="30" class="goalDatabaseName" value="${object.goalDatabaseName}" /> <a
				...
				href="${pageContext.request.contextPath }/dde/databaseInfo!defSourceAndDestDatabase.do?s_type=dest"
...
<%-- <div class="pageContent"
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add"
				href="${pageContext.request.contextPath }/dde/addressBook!edit.do?usercode={usercode}&bodytype=${param['s_bodytype']}"
				warn="请选择一个用户" target='navTab'><span>新增</span></a></li>
			<li><a class="delete"
				href="${pageContext.request.contextPath }/dde/addressBook!view.do?usercode={usercode}"
