...
<div id="div_exchange_sourceds_form" class="pageContent">
	<s:form action="#" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		...
		<div class="pageFormContent" layoutH="58">		
			<div class="unit">
				<label>数据库连接：</label> 
				<select id="sel_sourceds"  name="sourceDatabaseName">
			...
			<div class="unit">
				<label>查询语句：</label> 
				<textarea id="text_querySql" name="querySql" type="text" cols="60" rows="10" ></textarea>
			...
			<ul>
				<li><div class="buttonActive">
						<div class="buttonContent">
							<button id="btn_source_ds" type="button">保存</button>
						</div>
					</div></li>
				<li>
					<div class="button">
						<div class="buttonContent">
							<button id="btn_source_ds_close" type="button" class="close">取消</button>
						</div>
					</div>
				</li>
			</ul>
...
<script>
	$(function(){
		...
		port.pubfuns.defSourceDsInit();
		port.bind("bindSourceDs");
