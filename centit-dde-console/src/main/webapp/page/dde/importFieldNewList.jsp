...
<div class="pageHeader">
	<form id="frm_main" action="${pageContext.request.contextPath }/dde/importOpt!save.do" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<%-- 隐藏Field表单 --%>
		<fieldlist id="hid_field_form_list">
	    ...
	    <div id="div_export_field" class="pageFormContent" style="height: 100px;">
	        <div class="unit">
					...
					<input id="txt_sdn" type="text" size="30" class="datasource" value="${object.destDatabaseName }" /> 
