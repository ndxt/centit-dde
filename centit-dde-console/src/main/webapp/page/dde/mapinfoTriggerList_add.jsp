...
<div class="pageContent">
	<%-- <div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${contextPath }/dde/mapInfoTrigger!add_add.do?mapInfoId={s_mapinfoId}"  target='dialog' width="500" height="350"><span>添加</span></a></li>
			<li><a class="edit" href="${contextPath }/dde/mapInfoTrigger!edit_add.do?mapInfoId={s_mapinfoId}&triggerId={pk}" warn="请选择一条记录" target='dialog' width="500" height="350"><span>编辑</span></a></li>
	...
	<c:set var="addtrigger">
        <div class="panelBar">
            <ul class="toolBar">
                <li class="new">
                  <a class="add" href="${contextPath }/dde/mapInfoTrigger!add_add.do?mapInfoId={s_mapinfoId}"
	...
	<div layoutH="55">
	<form id="mapinfoTriggerList_add">
			...
			<tbody align="center">
				<c:forEach items="${objList }" var="mapInfoTrigger" varStatus="s">
						<tr target="pk" rel="${mapInfoTrigger.triggerId}">
							    ...
							    <td>
						           <a href="${contextPath }/dde/mapInfoTrigger!edit_add.do?mapInfoId={s_mapinfoId}&triggerId=${mapInfoTrigger.triggerId}"
						              target='dialog' width="550" height="450" title="编辑触发器"><span class="icon icon-edit"></span></a>
						           <a href="${contextPath }/dde/mapInfoTrigger!delete.do?mapInfoId={s_mapinfoId}&triggerId=${mapInfoTrigger.triggerId}"
